...
# EchoSEO Link Prospecting

## Goal

Find realistic pages, sites, and authors that might reference the user's page, product, study, guide, or tool. Use EchoSEO for prospect discovery, then use available web/search/browser tools for contact discovery.
...
After EchoSEO identifies good prospects, use available non-EchoSEO browsing or search tools for public contact discovery. Depending on the client, this may be web search, page fetches, browser automation, or a search API.
...
- Do not say EchoSEO found contact details unless an EchoSEO tool returned them. Attribute contact discovery to the web/search/browser source used.
