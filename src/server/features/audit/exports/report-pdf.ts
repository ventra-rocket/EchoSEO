...
/**
 * How long a single render may take. Browser Rendering bills wall time and a
 * hung page would otherwise hold a session for its whole idle timeout; the
 * report is static HTML with no network of its own, so this is generous.
 */
