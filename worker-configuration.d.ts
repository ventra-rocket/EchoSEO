/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 506b45a4efb0c9be40fef1917053807a)
// Runtime types generated with workerd@1.20260611.1 2025-09-02 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	FREE_CHECK_PUBLIC_ORIGIN: "https://app.echoseo.ventrarocket.vn";
	APP_PUBLIC_ORIGIN: "https://app.echoseo.ventrarocket.vn";
	...
	ASSISTANT_WORKSPACE: DurableObjectNamespace<import("./src/server").AssistantWorkspaceAgent>;
	WEEKLY_REPORT: DurableObjectNamespace<import("./src/server").WeeklyReportAgent>;
	RATE_LIMIT_DO: DurableObjectNamespace<import("./src/server").IpRateLimiterDO>;
	...
	DEEP_SEO_CHECK_WORKFLOW: Workflow<Parameters<import("./src/server").DeepSeoCheckWorkflow['run']>[0]['payload']>;
	AUDIT_EXPORT_WORKFLOW: Workflow<Parameters<import("./src/server").AuditExportWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "OnboardingChatAgent" | "IpRateLimiterDO" | "AssistantWorkspaceAgent" | "WeeklyReportAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_MODE" | "HOSTED_ACCESS_OPEN" | "FREE_CHECK_PUBLIC_ORIGIN" | "APP_PUBLIC_ORIGIN" | "FREE_CHECK_EMAIL_FROM" | "AUTH_EMAIL_FROM" | "GOOGLE_AUTH_ENABLED" | "TURNSTILE_SITE_KEY">> {}
}
