...
Set up [EchoSEO MCP](/docs/mcp) so your agent can research keywords, inspect SERPs, compare domains, and review backlink overview data when authority matters.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitive Landscape skill](https://github.com/ventra-rocket/EchoSEO/tree/main/.agents/skills/competitive-landscape)
