...
- Recommend the next EchoSEO Agent Skill to run.
...
Set up [EchoSEO MCP](/docs/mcp) so your agent can confirm the right EchoSEO project and use live SEO data in later workflows.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Project Setup skill](https://github.com/ventra-rocket/EchoSEO/tree/main/.agents/skills/seo-project-setup)
