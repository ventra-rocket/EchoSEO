...
Set up [EchoSEO MCP](/docs/mcp) so your agent can read saved keywords, inspect SERPs, and use EchoSEO project context while clustering.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Keyword Clustering skill](https://github.com/ventra-rocket/EchoSEO/tree/main/.agents/skills/keyword-clustering)
