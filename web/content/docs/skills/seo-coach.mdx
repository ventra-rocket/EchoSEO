...
- Help you choose the next EchoSEO Agent Skill based on your goal.
- Distinguish strategy questions from execution work.
- Explain when to use EchoSEO MCP, web search, browser review, or local files.
...
- "What does EchoSEO help my agent do?"
...
The coach can help before MCP is connected, but your agent needs [EchoSEO MCP](/docs/mcp) for live keyword, SERP, domain, backlink, and saved keyword data.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [SEO Coach skill](https://github.com/ventra-rocket/EchoSEO/tree/main/.agents/skills/seo-coach)
