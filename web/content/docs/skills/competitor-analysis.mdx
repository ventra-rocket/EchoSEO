...
Set up [EchoSEO MCP](/docs/mcp) so your agent can inspect domain overview data, ranking keywords, SERPs, and backlink context.

## Read the actual skill

The source `SKILL.md` lives on GitHub:

- [Competitor Analysis skill](https://github.com/ventra-rocket/EchoSEO/tree/main/.agents/skills/competitor-analysis)
